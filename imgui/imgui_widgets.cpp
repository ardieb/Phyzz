...
// Read code of e.g. SliderFloat(), SliderInt() etc. or impl in 'Demo->Widgets->Data Types' to understand how to use this function directly.
...
// Read code of e.g. InputFloat(), InputInt() etc. or impl in 'Demo->Widgets->Data Types' to understand how to use this function directly.
