...
{
    IM_ASSERT(ImGui::GetCurrentContext() != NULL && "Missing dear imgui context. Refer to impl app!"); // Exceptionally add an extra assert here for people confused with initial dear imgui setup
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("See example applications in the impl/ folder.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            // See "Combo" section for impl of how to use the more complete BeginCombo()/EndCombo() api.
...
static void ShowDemoWindowPopups()
{
    ...
    // This may be a bit confusing at first but it should quickly make sense. Follow on the impl below.
